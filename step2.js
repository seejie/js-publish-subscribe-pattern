...
// 模块、组件在支撑和组装整个系统时，不可避免的就是相互通信
// 系统拆的散可以提高维护性，与此同时必然会带来模块之间通讯难度的升级
// 常见的有：兄弟通信、父子通信、祖孙通信

// 订阅-发布模式就是一种很常见也很广泛应用于各种语言和场景中
...
// 简单来说，最起码至少应该有3个模块：订阅功能、发布功能、电话簿，看起来像是这样
const 卫星 = {
  电话簿: {},
  订阅: function(){},
  发布: function(){}
...
// 思考：
// 通过对事件列表数据结构的分析，以及对应的功能算法，猜测发布-订阅的模型写法
